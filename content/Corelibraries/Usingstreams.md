...
## Two kinds of streams 两种流

There are two kinds of streams.
有两种流。

### Single subscription streams 单一订阅流
...
## Methods that process a stream 处理流的方法
...
## Methods that modify a stream 修改流的方法
...
### The transform() function transform() 函数
...
### Reading and decoding a file 读取和解码文件
