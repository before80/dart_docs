...
### Transferring a package to a verified publisher 将软件包转移到已验证的发布者
...
#### Upgrade or downgrade to a version outside the specified version constraint 升级或降级到指定版本约束之外的版本
