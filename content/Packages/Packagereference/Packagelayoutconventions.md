...
![Flutter logo](https://dart.dev/assets/img/shared/flutter/icon/64.png) Flutter 注释：Flutter 应用可以使用自定义目录作为其资源。有关详细信息，请参阅 Flutter 网站上的添加资源和图像。
...
## Internal tools and scripts 内部工具和脚本
...
## Project-specific caching for tools 工具的项目特定缓存
